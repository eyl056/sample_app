class LeadStatusesController < ApplicationController
  before_action :set_lead_status, only: %i[ show edit update destroy ]

  # GET /lead_statuses or /lead_statuses.json
  def index
    @lead_statuses = LeadStatus.all
  end

  # GET /lead_statuses/1 or /lead_statuses/1.json
  def show
  end
  ...
  # POST /lead_statuses or /lead_statuses.json
  def create
  ...
  # PATCH/PUT /lead_statuses/1 or /lead_statuses/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /lead_statuses/1 or /lead_statuses/1.json
  def destroy
    @lead_status.destroy
    respond_to do |format|
  ...
  private
    ...
    def lead_status_params
      params.require(:lead_status).permit(:lead_status_id, :lead_status_name)
    end
end
