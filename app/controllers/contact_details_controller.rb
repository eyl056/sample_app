class ContactDetailsController < ApplicationController
  before_action :set_contact_detail, only: %i[ show edit update destroy ]

  # GET /contact_details or /contact_details.json
  def index
    @contact_details = ContactDetail.all
  end

  # GET /contact_details/1 or /contact_details/1.json
  def show
  end
  ...
  # POST /contact_details or /contact_details.json
  def create
  ...
  # PATCH/PUT /contact_details/1 or /contact_details/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /contact_details/1 or /contact_details/1.json
  def destroy
  ...
  private
    ...
    def contact_detail_params
      params.require(:contact_detail).permit(:contact_id, :contact_detail_info, :contact_detail_type)
    end
end
