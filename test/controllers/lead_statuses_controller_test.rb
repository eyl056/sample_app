...
class LeadStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lead_status" do
    assert_difference('LeadStatus.count') do
      post lead_statuses_url, params: { lead_status: { lead_status_id: @lead_status.lead_status_id, lead_status_name: @lead_status.lead_status_name } }
    end
  ...
  test "should update lead_status" do
    patch lead_status_url(@lead_status), params: { lead_status: { lead_status_id: @lead_status.lead_status_id, lead_status_name: @lead_status.lead_status_name } }
