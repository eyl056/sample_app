...
class OpportunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post opportunities_url, params: { opportunity: { confidence: @opportunity.confidence, created_at: @opportunity.created_at, date: @opportunity.date, estimated_close: @opportunity.estimated_close, notes: @opportunity.notes, opportunity_id: @opportunity.opportunity_id, value: @opportunity.value } }
    end
  ...
  test "should update opportunity" do
    patch opportunity_url(@opportunity), params: { opportunity: { confidence: @opportunity.confidence, created_at: @opportunity.created_at, date: @opportunity.date, estimated_close: @opportunity.estimated_close, notes: @opportunity.notes, opportunity_id: @opportunity.opportunity_id, value: @opportunity.value } }
